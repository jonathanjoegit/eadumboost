...
/* navbar */
$string['dashboard'] = 'Dashboard'; /* Attention : utilisé en css */
...
$string['connect-other-users'] = '<i>Other users</i> and <i>Université de Tours</i>';
...
$string['connect-angers-button'] = 'With your account <i>Université Angers</i>';
